class GameSettings:
    def __init__(self):
        ...
        self.protector_target_reach_distance = 2 # TODO: calculate distance threshold based protectors radius
        ...
        self.protector_deceleration_rate = 60  # Adjust for how quickly the entity decelerates
        self.protector_slowdown_distance = 50  # Start decelerating when within this range
